...
folder are mapped to the application's root namespace, 'iplinfo'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'iplinfo' in the same way
as `"iplinfo/sass/src"`.
